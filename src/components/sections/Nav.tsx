      ...
      <div className="px-6 md:px-12 max-w-6xl mx-auto flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            download
            className="hidden md:inline-block font-body text-sm text-accent border border-accent px-4 py-1.5 shadow-sm hover:border-ink hover:text-ink transition-colors"
          >
            Resume
          </a>
      ...
      {open && (
        <nav className="md:hidden border-t border-hairline bg-background px-6 py-6 flex flex-col gap-4">
          ...
          <a
            ...
            download
            onClick={() => setOpen(false)}
            className="font-body text-sm text-accent border border-accent px-4 py-2.5 shadow-sm text-center mt-2"
          >
            Resume
          </a>
        </nav>
